...
?>
        <div class="row banner">
            <div class="banner-text">
                <h1 class="responsive-headline">Сайн уу <?php echo ($user['lastname']); ?> байна.</h1>
                ...
                <hr />
                <ul class="social">
                    <li><a target="_blank" href="<?php echo $contact['facebook'] ?>"><i class="fa fa-facebook"></i></a>
                    </li>
                    <li><a target="_blank" href="<?php echo $contact['twitter'] ?>"><i class="fa fa-twitter"></i></a>
                    </li>
                    <li><a target="_blank" href="mailto:<?php echo $contact['email'] ?>"><i
                                class="fa fa-google-plus"></i></a></li>
                    <li><a target="_blank" href="<?php echo $contact['linkin'] ?>"><i class="fa fa-linkedin"></i></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section id="about">
        ...
        <div class="row">
            ...
            <div class="three columns">
                ...
                <img class="profile-pic" src="uploads/myimg.jpg" alt=""
                    style="width: 100%; height:150%; margin-left:-3cm;" />
...
?>
                <div class="row item">
                    ...
                    <div class="twelve columns">
                        ...
                        <p class="info"><?php echo $row['degree'] ?> <span>&bull;</span> <em
                                class="date"><?php echo $row['month'] . ' ' . $row['year'] ?></em></p>
...
?>
                <div class="row item">
                    ...
                    <div class="twelve columns">
                        ...
                        <p class="info"><?php echo $row['position'] ?> <span>&bull;</span> <em
                                class="date"><?php echo str_replace("_", " ", $row['started']) ?> -
                                <?php echo str_replace("_", " ", $row['ended']) ?></em></p>
